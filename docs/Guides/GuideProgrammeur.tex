...
% \caption{En-tête visible sur toutes les pages de l'interface Staff}
% \end{figure}


\begin{figure}[h!]
\centering
\includegraphics[scale=1]{tableau.png}
\caption{Exemple d'un tableau d'affichage list.php}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[scale=1]{modal.png}
\caption{Exemple d'une vue sur les détails (show.php)}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[scale=1]{form.png}
