...
--
-- Host: localhost
-- Generation Time: Dec 11, 2015 at 05:36 PM
...
CREATE TABLE IF NOT EXISTS `History` (
  ...
  UNIQUE KEY `id_4` (`id`),
  KEY `id_2` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2621 ;
...
(2620, 7, 0, 'Suppression de toute l''année précédente.', 'Suppression', '2015-12-11', '17:35:00');
...
--
-- Dumping data for table `OldTerrain`
--

INSERT INTO `OldTerrain` (`ID`, `adresse`, `surface`, `ID_Owner`, `etat`, `disponibiliteFrom`, `disponibiliteTo`, `CreationDate`, `Type`, `Note`, `StaffNote`) VALUES
