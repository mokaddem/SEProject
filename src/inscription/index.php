...
<body style="background : url(../images/player-back.jpg) 0 0 fixed no-repeat;">
...
<script type="text/javascript">
    window.onload = function () {
        document.getElementsByName("extraNone2")[0].addEventListener("click", function () {
            hideExtras("2");
        });
        document.getElementsByName("extraNone1")[0].addEventListener("click", function () {
            hideExtras("1");
        });
    };
</script>
