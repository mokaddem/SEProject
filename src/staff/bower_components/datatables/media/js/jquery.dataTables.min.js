...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate à sort column ascending",sSortDescending:": activate à sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"No data available in table",sInfo:"Affiche de _START_ à _END_ (_TOTAL_ entrées)",sInfoEmpty:"Affiche de 0 à 0 (0 entrées)",sInfoFiltered:"(filtered from _MAX_ total entrées))",
