                ...
                <div id="page-wrapper" style="background : url(../../images/staff-back.jpg) 0 0 fixed;">
                    <div class="container-fluid">
                        ...
                        <div class="pull-right">
                            <a href="./php/delete-all.php" onclick="return confirm('Voulez-vous vraiment passer à l\'année suivante ? Cette action va altérer de manière irrémédiable la base de donnée.');" class="btn btn-danger btn-outline"> Passer à l'année suivante <i class="fa fa-trash"></i></a>
                        </div>
                      </span>
                        <!-- /.panel -->
                    </div>
