    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div id="page-wrapper" style="background : url(../../images/staff-back.jpg) 0 0 fixed;">
                        ...
                        <div class="col-lg-6 text-center">
                            <fieldset data-role="controlgroup" data-type="horizontal">
                                ...
                                <form name="form2" action="./php/add-all-knock-off.php">
                                    ...
                                    <button type="submit" id="generate" class="btn btn-success pull-left">Tout générer pour ce jour <i class="fa fa-refresh"></i></button>
                                </form>
                            </fieldset>
                            <hr>
                        </div>
                ...
                <!-- /.row -->
                <div id="spinnercontainer" class="col-lg-6 row">
                    <p id="btnspinner" ></p>
                </div>
                <div class="col-lg-2 text-center pull-left">
                    <div class="btn btn-success disabled" id="popup">Génération en cours... </div>
                </div>
            </div>
            <!-- /#page-wrapper -->
