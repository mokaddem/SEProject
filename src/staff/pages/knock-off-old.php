    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <form role="form" action="../pages/knock-off.php?jour="<?=$_GET['jour']?>"&size="<?=$_GET['size']?>"&submit=Créer">
                        <div class="row">
                            <ul class="nav nav-tabs">
                                <li <?php if ($_GET['jour']=="sam" ) echo 'class="active" ' ;?>><a href="knock-off.php?jour=sam&size="<?=$_GET['size']?>">Samedi</a></li>
                                <li <?php if ($_GET['jour']=="dim" ) echo 'class="active" ' ;?>><a href="knock-off.php?jour=dim&size="<?=$_GET['size']?>"">Dimanche</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-3">
                            <hr>
