                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php foreach (getPlayers() as $player){ ?>
                                                    <tr class="odd gradeX">
                                                        <td data-toggle="modal" data-target="#myModal<?=$player['ID']?>" data-url="./show-player.php?id=<?=$player['ID']?>">
                                                            <?=$player['ID']?>
                                                        </td>
                                                        <td data-toggle="modal" data-target="#myModal<?=$player['ID']?>" data-url="./show-player.php?id=<?=$player['ID']?>">
                                                            <?=$player['LastName']?>
                                                        ...
                                                        <td class="center" data-toggle="modal" data-target="#myModal<?=$player['ID']?>" data-url="./show-player.php?id=<?=$player['ID']?>">
                                                            <?=$player['BirthDate']?>
                                                        </td>
                                                        <td class="center" data-toggle="modal" data-target="#myModal<?=$player['ID']?>" data-url="./show-player.php?id=<?=$player['ID']?>">
                                                            <?=$player['CreationDate']?>
